...
local watermark = library:Watermark("Kali's Personal Lock | 851 fps | V1.10 | Egokiller Edition")
-- watermark:Set("Watermark Set")
-- watermark:Hide() -- toggles watermark

local main = library:Load{
    Name = "Kali's Personal Lock | Egokiller Edition",
    SizeX = 600,
    SizeY = 650,
    Theme = "Midnight",
    Extension = "json", -- config file extension
    Folder = "KPL Egokiller Edition Config" -- config folder name
}

-- library.Extension = "txt" (config file extension)
-- library.Folder = "config folder name"

local tab = main:Tab("Aiming I")
...
local label = section:Label("Enable KPL Lock (Q)")
...
section:Button{
    Name = "KPL Lock",
    Callback  = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/feellikegod666/KALISPERSONALLOCK/main/KALIS"))();
    end
}
